...
// Push method - O(n): Increases amount of reserved memory and set value of final block to contain the new value
...
// What about if you want to insert a value into any point in an array, not just the middle? To do this, you need to shift all of the values after the new value forward one position. Then you put the new value in its correct place.
